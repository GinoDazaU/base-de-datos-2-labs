...
SELECT id, cube(array(select random()*1000 FROM generate_series(1, 2)))
...
SELECT id, cube(array(select random()*1000 FROM generate_series(1, 4)))
FROM generate_series(1, 1000000) id;
...
SELECT id, cube(array(select random()*1000 FROM generate_series(1, 6)))
FROM generate_series(1, 1000000) id;
...
SELECT id, cube(array(select random()*1000 FROM generate_series(1, 8)))
FROM generate_series(1, 1000000) id;
...
SELECT id, cube(array(select random()*1000 FROM generate_series(1, 16)))
FROM generate_series(1, 1000000) id;
...
SELECT id, cube(array(select random()*1000 FROM generate_series(1, 32)))
FROM generate_series(1, 1000000) id;
...
SELECT id, cube(array(select random()*1000 FROM generate_series(1, 64)))
FROM generate_series(1, 1000000) id;
